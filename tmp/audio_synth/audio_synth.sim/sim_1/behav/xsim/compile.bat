...
REM
REM Generated by Vivado on Sat Aug 16 14:00:06 -0400 2025
...
echo "xvlog --incr --relax -prj tb_spi_master_vlog.prj"
call xvlog  --incr --relax -prj tb_spi_master_vlog.prj -log xvlog.log
