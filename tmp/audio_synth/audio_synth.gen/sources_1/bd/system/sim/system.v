...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  system_axis_red_pitaya_dac_0_0 axis_red_pitaya_dac_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        ...
        .s_axis_tvalid(1'b0));
  system_clk_wiz_0_0 clk_wiz_250MHz
       (.clk_in1(processing_system7_0_FCLK_CLK0),
        .clk_out1(clk_wiz_0_clk_out1),
        .locked(clk_wiz_0_locked));
  system_clk_wiz_0_1 clk_wiz_30MHz
       (.clk_in1(processing_system7_0_FCLK_CLK0));
  system_util_ds_buf_0_0 util_ds_buf_0
       (.IBUF_DS_N({adc_clk_n_i,adc_clk_n_i}),
        .IBUF_DS_P({adc_clk_p_i,adc_clk_p_i}));
